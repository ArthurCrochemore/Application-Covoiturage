...
const fetchTripDetails = async () => {
  console.log("Id du trajet:", route.query.idTrajet)
  try {
...
async function annuler() {
  try {
    const response = await axios.post('/annuler-reservation', {
      Id_Trajet: route.query.idTrajet,
    });
    afficherMessageFunc("La réservation a été annulée", "Succès");
    router.push({
      path: '/vos-trajets',
    });
  } catch (error) {
